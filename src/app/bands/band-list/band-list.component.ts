...
export class BandListComponent implements OnInit {
  ...
  bands: Band[] = [
    new Band('KISS', 
              ...
              'https://www.youtube.com/watch?v=B_oFiNdp8UQ'),
    new Band('The Rolling Stones', 
              ...
              'https://www.youtube.com/watch?v=O4irXQhgMqg&list=RDEM07sWLP40fqgolm2qkwr-DQ&start_radio=1'),
    new Band('AC/DC', 
              'Kiss es una banda estadounidense de rock formada en Nueva York en enero de 1973 por el bajista Gene Simmons y el guitarrista Paul Stanley, a los que más tarde se unirían el batería Peter Criss y el guitarrista Ace Frehley.​', 
              ...
              'https://www.youtube.com/watch?v=ikFFVfObwss&list=PLxGB9kNnluF766VGi9mOsgK1JJb7Rtf2f'),
    new Band('Queen', 
              ...
              'https://www.youtube.com/watch?v=HgzGwKwLmgM&list=RDEMbHaAxpOZhcVmmF6I3y0siA&start_radio=1'),
    ...
    new Band('Pink Floyd', 
              ...
              'https://www.youtube.com/watch?v=QGe8ecStkfQ'),
    new Band('Deep Purple', 
              ...
              'https://www.youtube.com/watch?v=I7PHolrHOck'),
    new Band('The Ramones', 
